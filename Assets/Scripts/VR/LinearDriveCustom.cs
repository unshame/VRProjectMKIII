...
namespace Valve.VR.InteractionSystem {
    ...
    public class LinearDriveCustom : MonoBehaviour {
        ...
        public GameObject objectToDrive = null;
        ...
        private void UpdateLinearMapping(Transform tr) {
            ...
            if (repositionGameObject) {
                GetTransform().position = (GetTransform().position - transform.position) + Vector3.Lerp(startPosition.position, endPosition.position, linearMapping.value);
            }
        }

        private Transform GetTransform() {
            return objectToDrive ? objectToDrive.transform : transform;
        }
